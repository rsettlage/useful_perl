...
my $blastfile = $fastqfile .".gz.phiX.bln.txt";   #####<----------------------change this
...
my $out_hit=$base . ".MHC_BAC_blast_hit.fastq";  #####<----------------------change this
my $out_nohit=$base . ".MHC_BAC_blast_nohit.fastq";  #####<----------------------change this
