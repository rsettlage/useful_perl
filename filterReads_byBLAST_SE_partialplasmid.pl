...
my $blastfile = "Grabau_Oct2013_W73ane2_partialplasmidhit_R2.bln.txt"; ##$fastqfile .".plasmid.bln.txt";   #####<----------------------change this
...
my $out_hit=$base . ".Partial_plasmid_hit.fastq";  #####<----------------------change this
my $out_nohit=$base . ".Partial_plasmid_nohit.fastq";  #####<----------------------change this
